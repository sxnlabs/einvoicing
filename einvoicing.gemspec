...
Gem::Specification.new do |s|
  ...
  # Neither is a default gem any more: bigdecimal was demoted in Ruby 3.4, rexml
  # back in Ruby 3.0. lib/ requires both, so a consumer bundle that does not
  # carry them fails — bigdecimal at load time, rexml when Peppol validation
  # parses SVRL. rexml is floored at the release that fixed its parsing DoS,
  # because validators/peppol.rb feeds it data derived from supplier invoices.
